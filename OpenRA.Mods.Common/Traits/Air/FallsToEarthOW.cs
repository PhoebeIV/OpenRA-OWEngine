...
namespace OpenRA.Mods.Common.Traits
{
	...
	public class FallsToEarthOWInfo : TraitInfo, IRulesetLoaded, Requires<AircraftInfo>
	{
		[WeaponReference]
		...
		[Desc("Credit damage to owner of actor?")]
		public readonly bool FiredByOwner = false;

		public WeaponInfo ExplosionWeapon { get; private set; }

		public override object Create(ActorInitializer init) { return new FallsToEarthOW(init, this); }
	...
	public class FallsToEarthOW : IEffectiveOwner, INotifyCreated
	{
		readonly FallsToEarthOWInfo info;
		readonly Player effectiveOwner;

		public FallsToEarthOW(ActorInitializer init, FallsToEarthOWInfo info)
		{
			this.info = info;
		...
		{
			self.QueueActivity(false, new FallToEarthOW(self, info));
		}
	}
}
