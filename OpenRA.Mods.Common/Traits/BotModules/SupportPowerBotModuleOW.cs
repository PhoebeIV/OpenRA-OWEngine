...
namespace OpenRA.Mods.Common.Traits
{
	...
	public class SupportPowerBotModuleOWInfo : ConditionalTraitInfo, Requires<SupportPowerManagerInfo>
	{
		...
		public override object Create(ActorInitializer init) { return new SupportPowerBotModuleOW(init.Self, this); }
	}

	public class SupportPowerBotModuleOW : ConditionalTrait<SupportPowerBotModuleOWInfo>, IBotTick, IGameSaveTraitData
	{
		...
		public SupportPowerBotModuleOW(Actor self, SupportPowerBotModuleOWInfo info)
			: base(info)
		{
			world = self.World;
			player = self.Owner;
		...
		{
			foreach (var decision in Info.Decisions)
				powerDecisions.Remove(decision.OrderName);
		}
