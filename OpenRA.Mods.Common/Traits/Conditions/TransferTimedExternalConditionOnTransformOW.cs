...
namespace OpenRA.Mods.Common.Traits
{
	...
	{
		readonly TransferTimedExternalConditionOnTransformOWInfo info;
		int duration = 0;
		int remaining = 0;

		public TransferTimedExternalConditionOnTransform(TransferTimedExternalConditionOnTransformOWInfo info)
		{
			this.info = info;
		}
